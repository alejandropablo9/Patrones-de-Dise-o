...
public class ConsultaJpaController implements Serializable {
    ...
    public List<Consulta> findConsultaWithCita(int idcita) {
        EntityManager em = getEntityManager();
        
        return em.createQuery("SELECT c FROM Consulta c WHERE c.idcita = ?1")
        //return em.createNamedQuery("Consulta.findByIdcita")

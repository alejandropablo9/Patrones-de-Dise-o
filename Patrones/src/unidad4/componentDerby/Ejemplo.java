...
public class Ejemplo extends JPanel {
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == newButton) {
                Ejemplo.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                Ejemplo.this.deleteButtonActionPerformed(evt);
            }
            else if (evt.getSource() == saveButton) {
                Ejemplo.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                Ejemplo.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteDetailButton) {
                Ejemplo.this.deleteDetailButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newDetailButton) {
                Ejemplo.this.newDetailButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteDetailButtonActionPerformed
        ...
        unidad4.componentDerby.Customer c = list.get(masterTable.convertRowIndexToModel(index));
        Collection<unidad4.componentDerby.PurchaseOrder> ps = c.getPurchaseOrderList();
        int[] selected = detailTable.getSelectedRows();
        List<unidad4.componentDerby.PurchaseOrder> toRemove = new ArrayList<unidad4.componentDerby.PurchaseOrder>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            selected[idx] = detailTable.convertRowIndexToModel(selected[idx]);
            int count = 0;
            Iterator<unidad4.componentDerby.PurchaseOrder> iter = ps.iterator();
            while (count++ < selected[idx]) {
                iter.next();
            }
            unidad4.componentDerby.PurchaseOrder p = iter.next();
            toRemove.add(p);
    ...
    private void newDetailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newDetailButtonActionPerformed
        ...
        Collection<unidad4.componentDerby.PurchaseOrder> ps = c.getPurchaseOrderList();
        if (ps == null) {
            ps = new LinkedList<unidad4.componentDerby.PurchaseOrder>();
            c.setPurchaseOrderList((List) ps);
        }
        unidad4.componentDerby.PurchaseOrder p = new unidad4.componentDerby.PurchaseOrder();
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<unidad4.componentDerby.Customer> toRemove = new ArrayList<unidad4.componentDerby.Customer>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            unidad4.componentDerby.Customer c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        unidad4.componentDerby.Customer c = new unidad4.componentDerby.Customer();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<unidad4.componentDerby.Customer> merged = new ArrayList<unidad4.componentDerby.Customer>(list.size());
            for (unidad4.componentDerby.Customer c : list) {
    ...
    private java.util.List<unidad4.componentDerby.Customer> list;
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new Ejemplo());
